...
function Navbar() {
  ...
  return (
    <nav>
      ...
      {isLoggedIn ? (
        <>
          <Link to="/">{/* <button>Reservas</button> */}</Link>
          <button className="boton-nav-logout" onClick={logOutUser}>
            Logout
          </button>
        ...
        <>
          <Link to="/signup">
            {' '}
            <button className="boton-nav-signup">Signup</button>{' '}
          </Link>
          <Link to="/login">
            {' '}
            <button className="boton-nav-login">Login</button>{' '}
          </Link>
        </>
      )}
    </nav>
