...
const OficinaPage = () => {
  ...
  return (
    <Container className="formulario">
      ...
      />
      <InputCustom
        minDate={todayFormated}
        value={book.daySelected}
        handleChange={handleChange}
        type="date"
        legendName="Date"
        name="daySelected"
      ...
      <a href="/formulario-reserva">
        <button className="boton-reserva">Reserves </button>
      </a>
    </Container>
  )
}
